    ...
    <SidebarLayout onLogout={handleLogout}>
      <div style={{ position: 'relative', width: '100%', margin: '0 auto', padding: '0 20px' }}>
        <div style={{ position: 'absolute', left: 0, right: 0, top: 0, textAlign: 'center', zIndex: 1, pointerEvents: 'none' }}>
          <h2 style={{ color: 'var(--color-primary)', fontWeight: 'var(--font-weight-bold)', margin: 0, paddingTop: 0, paddingBottom: 18 }}>Sample 1 Page</h2>
        </div>
        <div style={{ paddingTop: 60 }}>
          <p>This is the Sample 1 page. The sidebar and top bar are preserved.</p>
