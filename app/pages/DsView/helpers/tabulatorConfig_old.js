// Tabulator configuration and callbacks
...
import mditFancyLists from 'markdown-it-fancy-lists';
import mditMathjax3 from 'markdown-it-mathjax3';
...
export default function createTabulatorConfig(context) {
  const { tabulatorRef, viewConfig, dsName, dsView, userId } = context;
