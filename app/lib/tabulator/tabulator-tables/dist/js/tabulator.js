(function (global, factory) {
  ...
  (function (global, factory) {
    ...
    // ===== Included from column_manager.js =====
    ...
    ColumnManager.prototype._addColumn = function (definition, before, nextToColumn) {
      var column = new _Column(definition, this),
    ...
    ColumnManager.prototype.scrollToColumn = function (column, position, ifVisible) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (column.visible) {
          ...
          left = colEl.offsetLeft + _this3.element.scrollLeft + adjust;
    ...
    // ===== End of column_manager.js =====

    // ===== Included from column.js =====
    ...
    ColumnComponent.prototype.getParentColumn = function () {
      return this._column.parent instanceof _Column ? this._column.parent.getComponent() : false;
    };
    ...
    var _Column = function Column(def, parent) {
      var self = this;
      ...
      if (def.columns) {
        ...
        def.columns.forEach(function (def, i) {
          var newCol = new _Column(def, self);
    ...
    _Column.prototype.createElement = function () {
      var el = document.createElement("div");
    ...
    _Column.prototype.createGroupElement = function () {
      var el = document.createElement("div");
      el.classList.add("tabulator-col-group-cols");
      return el;
    };
    _Column.prototype.checkDefinition = function () {
      var _this5 = this;
    ...
    _Column.prototype.setField = function (field) {
      this.field = field;
    ...
    _Column.prototype.registerColumnPosition = function (column) {
      this.parent.registerColumnPosition(column);
    };

    //register column position with column manager
    _Column.prototype.registerColumnField = function (column) {
      this.parent.registerColumnField(column);
    };

    //trigger position registration
    _Column.prototype.reRegisterPosition = function () {
      if (this.isGroup) {
        this.columns.forEach(function (column) {
          column.reRegisterPosition();
        });
    ...
    _Column.prototype._mapDepricatedFunctionality = function () {
    ...
    _Column.prototype.setTooltip = function () {
      var self = this,
        def = self.definition;
    ...
    _Column.prototype._buildHeader = function () {
      var self = this,
        def = self.definition;
    ...
    _Column.prototype._bindEvents = function () {
      var self = this,
        def = self.definition,
        dblTap,
        tapHold,
    ...
    _Column.prototype._buildColumnHeader = function () {
      var _this6 = this;
    ...
    _Column.prototype._buildColumnHeaderContent = function () {
      var def = this.definition,
        table = this.table;
    ...
    _Column.prototype._buildColumnHeaderTitle = function () {
      var self = this,
        def = self.definition,
        table = self.table,
        title;
    ...
    _Column.prototype._formatColumnHeaderTitle = function (el, title) {
      var _this7 = this;
    ...
    _Column.prototype._buildGroupHeader = function () {
      var _this8 = this;
    ...
    //flat field lookup
    _Column.prototype._getFlatData = function (data) {
      return data[this.field];
    };

    //nested field lookup
    _Column.prototype._getNestedData = function (data) {
      var dataObj = data,
    ...
    //flat field set
    _Column.prototype._setFlatData = function (data, value) {
      if (this.field) {
    ...
    //nested field set
    _Column.prototype._setNestedData = function (data, value) {
      var dataObj = data,
        structure = this.fieldStructure,
        length = structure.length;
    ...
    _Column.prototype.attachColumn = function (column) {
      var self = this;
    ...
    _Column.prototype.verticalAlign = function (alignment, height) {
    ...
    _Column.prototype.clearVerticalAlign = function () {
    ...
    _Column.prototype.bindModuleColumns = function () {
    ...
    _Column.prototype.getElement = function () {
      return this.element;
    };

    //return colunm group element
    _Column.prototype.getGroupElement = function () {
      return this.groupElement;
    };

    //return field name
    _Column.prototype.getField = function () {
      return this.field;
    };

    //return the first column in a group
    _Column.prototype.getFirstColumn = function () {
      if (!this.isGroup) {
        return this;
      } else {
    ...
    _Column.prototype.getLastColumn = function () {
      if (!this.isGroup) {
        return this;
      } else {
        if (this.columns.length) {
    ...
    _Column.prototype.getColumns = function () {
      return this.columns;
    };

    //return all columns in a group
    _Column.prototype.getCells = function () {
      return this.cells;
    };

    //retreive the top column in a group of columns
    _Column.prototype.getTopColumn = function () {
    ...
    _Column.prototype.getDefinition = function (updateBranches) {
      var colDefs = [];
    ...
    _Column.prototype.checkColumnVisibility = function () {
      var visible = false;
      this.columns.forEach(function (column) {
        if (column.visible) {
          visible = true;
    ...
    //show column
    _Column.prototype.show = function (silent, responsiveToggle) {
      if (!this.visible) {
        this.visible = true;
    ...
    //hide column
    _Column.prototype.hide = function (silent, responsiveToggle) {
      if (this.visible) {
        this.visible = false;
    ...
    _Column.prototype.matchChildWidths = function () {
      var childWidth = 0;
    ...
    _Column.prototype.setWidth = function (width) {
      this.widthFixed = true;
      this.setWidthActual(width);
    };
    _Column.prototype.setWidthActual = function (width) {
      if (isNaN(width)) {
    ...
    _Column.prototype.checkCellHeights = function () {
      var rows = [];
      this.cells.forEach(function (cell) {
    ...
    _Column.prototype.getWidth = function () {
      var width = 0;
      if (this.isGroup) {
        this.columns.forEach(function (column) {
          if (column.visible) {
    ...
    _Column.prototype.getHeight = function () {
      return this.element.offsetHeight;
    };
    _Column.prototype.setMinWidth = function (minWidth) {
    ...
    _Column.prototype.delete = function () {
      var _this9 = this;
      return new Promise(function (resolve, reject) {
        if (_this9.isGroup) {
    ...
    _Column.prototype.columnRendered = function () {
      if (this.titleFormatterRendered) {
        this.titleFormatterRendered();
      }
    };
    _Column.prototype.validate = function () {
      var invalid = [];
      this.cells.forEach(function (cell) {
        if (!cell.validate()) {
    ...
    _Column.prototype.generateCell = function (row) {
      var self = this;
      var cell = new Cell(self, row);
      this.cells.push(cell);
      return cell;
    };
    _Column.prototype.nextColumn = function () {
      var index = this.table.columnManager.findColumnIndex(this);
      return index > -1 ? this._nextVisibleColumn(index + 1) : false;
    };
    _Column.prototype._nextVisibleColumn = function (index) {
      var column = this.table.columnManager.getColumnByIndex(index);
      return !column || column.visible ? column : this._nextVisibleColumn(index + 1);
    };
    _Column.prototype.prevColumn = function () {
      var index = this.table.columnManager.findColumnIndex(this);
      return index > -1 ? this._prevVisibleColumn(index - 1) : false;
    };
    _Column.prototype._prevVisibleColumn = function (index) {
      var column = this.table.columnManager.getColumnByIndex(index);
      return !column || column.visible ? column : this._prevVisibleColumn(index - 1);
    };
    _Column.prototype.reinitializeWidth = function (force) {
    ...
    _Column.prototype.fitToData = function () {
      var self = this;
      if (!this.widthFixed) {
    ...
    _Column.prototype.updateDefinition = function (updates) {
      var _this0 = this;
      return new Promise(function (resolve, reject) {
        var definition;
        if (!_this0.isGroup) {
          definition = Object.assign({}, _this0.getDefinition());
          definition = Object.assign(definition, updates);
          _this0.table.columnManager.addColumn(definition, false, _this0).then(function (column) {
            if (definition.field == _this0.field) {
              _this0.field = false; //cleair field name to prevent deletion of duplicate column from arrays
            }
            _this0.delete().then(function () {
    ...
    //////////////// Object Generation /////////////////
    _Column.prototype.getComponent = function () {
      if (!this.component) {
    ...
    RowManager.prototype.scrollToRow = function (row, position, ifVisible) {
      ...
      return new Promise(function (resolve, reject) {
        if (rowIndex > -1) {
          if (typeof position === "undefined") {
            position = _this1.table.options.scrollToRowPosition;
          }
          if (typeof ifVisible === "undefined") {
            ifVisible = _this1.table.options.scrollToRowIfVisible;
          }
          if (position === "nearest") {
            switch (_this1.renderMode) {
              case "classic":
                rowTop = _Tabulator.prototype.helpers.elOffset(rowEl).top;
                position = Math.abs(_this1.element.scrollTop - rowTop) > Math.abs(_this1.element.scrollTop + _this1.element.clientHeight - rowTop) ? "bottom" : "top";
                break;
              case "virtual":
                position = Math.abs(_this1.vDomTop - rowIndex) > Math.abs(_this1.vDomBottom - rowIndex) ? "bottom" : "top";
                break;
            }
          }
          ...
          if (!ifVisible) {
            if (_Tabulator.prototype.helpers.elVisible(rowEl)) {
              offset = _Tabulator.prototype.helpers.elOffset(rowEl).top - _Tabulator.prototype.helpers.elOffset(_this1.element).top;
              if (offset > 0 && offset < _this1.element.clientHeight - rowEl.offsetHeight) {
                return false;
              }
            }
          }
          ...
          switch (_this1.renderMode) {
            case "classic":
              _this1.element.scrollTop = _Tabulator.prototype.helpers.elOffset(rowEl).top - _Tabulator.prototype.helpers.elOffset(_this1.element).top + _this1.element.scrollTop;
              break;
            case "virtual":
              _this1._virtualRenderFill(rowIndex, true);
              break;
          }
          ...
          switch (position) {
            case "middle":
            case "center":
              if (_this1.element.scrollHeight - _this1.element.scrollTop == _this1.element.clientHeight) {
                _this1.element.scrollTop = _this1.element.scrollTop + (rowEl.offsetTop - _this1.element.scrollTop) - (_this1.element.scrollHeight - rowEl.offsetTop) / 2;
              } else {
                _this1.element.scrollTop = _this1.element.scrollTop - _this1.element.clientHeight / 2;
              }
              break;
            case "bottom":
              if (_this1.element.scrollHeight - _this1.element.scrollTop == _this1.element.clientHeight) {
                _this1.element.scrollTop = _this1.element.scrollTop - (_this1.element.scrollHeight - rowEl.offsetTop) + rowEl.offsetHeight;
              } else {
                _this1.element.scrollTop = _this1.element.scrollTop - _this1.element.clientHeight + rowEl.offsetHeight;
              }
              break;
          }
          resolve();
    ...
    RowManager.prototype.refreshActiveData = function (stage, skipStage, renderInPosition) {
      ...
      if (this.redrawBlock) {
        ...
        if (_Tabulator.prototype.helpers.elVisible(self.element)) {
          if (renderInPosition) {
    ...
    RowManager.prototype._virtualRenderFill = function (position, forceMove, offset) {
      ...
      if (self.displayRowsCount && _Tabulator.prototype.helpers.elVisible(self.element)) {
    ...
    // ===== End of row_manager.js =====

    // ===== Included from vdom_hoz.js =====
    ...
    VDomHoz.prototype.initialize = function () {
      ...
      this.holderEl.addEventListener("scroll", function () {
        var left = _this15.holderEl.scrollLeft;
        if (_this15.scrollLeft != left) {
          _this15.scrollLeft = left;
          _this15.scroll(left - (_this15.vDomScrollPosLeft + _this15.window));
        }
      });
    };
    ...
    VDomHoz.prototype.reinitialize = function (update, blockRedraw) {
      ...
      this.table.columnManager.columnsByIndex.forEach(function (column) {
        ...
        if (column.visible) {
          ...
          if (colPos + width > _this16.vDomScrollPosLeft && colPos < _this16.vDomScrollPosRight) {
            //column is visible

            if (_this16.leftCol == -1) {
              _this16.leftCol = _this16.columns.length;
              _this16.vDomPadLeft = colPos;
            }
            _this16.rightCol = _this16.columns.length;
          } else {
            // column is hidden
            if (_this16.leftCol !== -1) {
              _this16.vDomPadRight += width;
            }
          }
          _this16.columns.push(column);
    ...
    VDomHoz.prototype.renitializeRows = function () {
      ...
      rows.forEach(function (row) {
        _this18.reinitializeRow(row, true);
      });
    };
    ...
    Row.prototype.initialize = function (force) {
      ...
      if (!this.initialized || force) {
        ...
        if (this.table.options.virtualDomHoz && this.table.vdomHoz.initialized) {
          ...
          this.cells.forEach(function (cell) {
            _this19.element.appendChild(cell.getElement());
            cell.cellRendered();
          });
        }
        if (force) {
    ...
    Row.prototype.updateData = function (updatedData) {
      var _this20 = this;
      var visible = _Tabulator.prototype.helpers.elVisible(this.element),
        tempData = {},
        newRowData;
      return new Promise(function (resolve, reject) {
        ...
        if (_this20.table.options.reactiveData && _this20.table.modExists("reactiveData", true)) {
          _this20.table.modules.reactiveData.block();
        }

        //mutate incomming data if needed
        if (_this20.table.modExists("mutator")) {
          tempData = Object.assign(tempData, _this20.data);
          tempData = Object.assign(tempData, updatedData);
          newRowData = _this20.table.modules.mutator.transformRow(tempData, "data", updatedData);
        } else {
        ...
        for (var attrname in newRowData) {
          _this20.data[attrname] = newRowData[attrname];
        }
        if (_this20.table.options.reactiveData && _this20.table.modExists("reactiveData", true)) {
          _this20.table.modules.reactiveData.unblock();
        }

        //update affected cells only
        for (var attrname in updatedData) {
          var columns = _this20.table.columnManager.getColumnsByFieldRoot(attrname);
          columns.forEach(function (column) {
            var cell = _this20.getCell(column.getField());
            if (cell) {
        ...
        if (_this20.table.options.groupUpdateOnCellEdit && _this20.table.options.groupBy && _this20.table.modExists("groupRows")) {
          _this20.table.modules.groupRows.reassignRowToGroup(_this20.row);
        }

        //Partial reinitialization if visible
        if (visible) {
          _this20.normalizeHeight(true);
          if (_this20.table.options.rowFormatter) {
            _this20.table.options.rowFormatter(_this20.getComponent());
          }
        } else {
          _this20.initialized = false;
          _this20.height = 0;
          _this20.heightStyled = "";
        }
        if (_this20.table.options.dataTree !== false && _this20.table.modExists("dataTree") && _this20.table.modules.dataTree.redrawNeeded(updatedData)) {
          _this20.table.modules.dataTree.initializeRow(_this20);
          _this20.table.modules.dataTree.layoutRow(_this20);
          _this20.table.rowManager.refreshActiveData("tree", false, true);
        }

        //this.reinitialize();

        _this20.table.options.rowUpdated.call(_this20.table, _this20.getComponent());
        if (_this20.table.options.dataChanged) {
          _this20.table.options.dataChanged.call(_this20.table, _this20.table.rowManager.getData());
        }
        resolve();
      });
    };
    ...
    Row.prototype.findNextEditableCell = function (index) {
      ...
      if (index < this.cells.length - 1) {
        for (var i = index + 1; i < this.cells.length; i++) {
          ...
          if (cell.column.modules.edit && _Tabulator.prototype.helpers.elVisible(cell.getElement())) {
            var allowEdit = true;
    ...
    Row.prototype.delete = function () {
      ...
      return new Promise(function (resolve, reject) {
        var index, rows;
        if (_this21.table.options.history && _this21.table.modExists("history")) {
          if (_this21.table.options.groupBy && _this21.table.modExists("groupRows")) {
            rows = _this21.getGroup().rows;
            index = rows.indexOf(_this21);
            if (index) {
              index = rows[index - 1];
            }
          } else {
            index = _this21.table.rowManager.getRowIndex(_this21);
            if (index) {
              index = _this21.table.rowManager.rows[index - 1];
            }
          }
          _this21.table.modules.history.action("rowDelete", _this21, {
            data: _this21.getData(),
            pos: !index,
            index: index
          });
        }
        _this21.deleteActual();
        resolve();
      });
    };
    ...
    Cell.prototype.getHeight = function () {
      ...
      if (this.table.modExists("edit", true)) {
        ...
        if (editing && editing._getSelf() === this) {
          ...
          //h = 150;
          if (this.heightSpecial) h = Math.max(h, this.heightSpecial);
        }
      }
    ...
    // ===== Included from footer_manager.js =====
    ...
    // ===== End of footer_manager.js =====

    var _Tabulator = function Tabulator(element, options) {
      this.options = {};
      ...
      _Tabulator.prototype.comms.register(this); //register table for inderdevice communication
    };

    //default setup options
    _Tabulator.prototype.defaultOptions = {
      height: false,
      //height of tabulator
      minHeight: false,
    ...
    _Tabulator.prototype.initializeOptions = function (options) {
    ...
    _Tabulator.prototype.initializeElement = function (element) {
    ...
    _Tabulator.prototype.rtlCheck = function () {
    ...
    _Tabulator.prototype._mapDepricatedFunctionality = function () {
    ...
    _Tabulator.prototype._clearSelection = function () {
    ...
    //concreate table
    _Tabulator.prototype._create = function () {
    ...
    _Tabulator.prototype._clearObjectPointers = function () {
    ...
    _Tabulator.prototype._buildElement = function () {
      var _this22 = this;
      ...
      if (options.initialHeaderFilter && this.modExists("filter", true)) {
        options.initialHeaderFilter.forEach(function (item) {
          var column = _this22.columnManager.findColumn(item.field);
          if (column) {
    ...
    //deconstructor
    _Tabulator.prototype.destroy = function () {
      var element = this.element;
      _Tabulator.prototype.comms.deregister(this); //deregister table from inderdevice communication
    ...
    _Tabulator.prototype._detectBrowser = function () {
    ...
    _Tabulator.prototype.blockRedraw = function () {
      return this.rowManager.blockRedraw();
    };

    //restore table redrawing
    _Tabulator.prototype.restoreRedraw = function () {
      return this.rowManager.restoreRedraw();
    };

    //local data from local file
    _Tabulator.prototype.setDataFromLocalFile = function (extensions) {
      var _this23 = this;
      return new Promise(function (resolve, reject) {
        ...
        input.addEventListener("change", function (e) {
          ...
          reader.onload = function (e) {
            ...
            _this23.setData(data).then(function (data) {
              resolve(data);
            }).catch(function (err) {
              resolve(err);
            });
    ...
    //load data
    _Tabulator.prototype.setData = function (data, params, config) {
      if (this.modExists("ajax")) {
        this.modules.ajax.blockActiveRequest();
      }
      return this._setData(data, params, config, false, true);
    };
    _Tabulator.prototype._setData = function (data, params, config, inPosition, columnsChanged) {
      var self = this;
    ...
    //clear data
    _Tabulator.prototype.clearData = function () {
      if (this.modExists("ajax")) {
        this.modules.ajax.blockActiveRequest();
      }
    ...
    _Tabulator.prototype.getData = function (active) {
      if (active === true) {
    ...
    _Tabulator.prototype.getDataCount = function (active) {
      if (active === true) {
    ...
    _Tabulator.prototype.searchRows = function (field, type, value) {
    ...
    _Tabulator.prototype.searchData = function (field, type, value) {
      if (this.modExists("filter", true)) {
    ...
    //get table html
    _Tabulator.prototype.getHtml = function (visible, style, config) {
    ...
    //get print html
    _Tabulator.prototype.print = function (visible, style, config) {
    ...
    //retrieve Ajax URL
    _Tabulator.prototype.getAjaxUrl = function () {
    ...
    _Tabulator.prototype.replaceData = function (data, params, config) {
      if (this.modExists("ajax")) {
        this.modules.ajax.blockActiveRequest();
      }
    ...
    //update table data
    _Tabulator.prototype.updateData = function (data) {
      var _this24 = this;
      var self = this;
      var responses = 0;
      return new Promise(function (resolve, reject) {
        if (_this24.modExists("ajax")) {
          _this24.modules.ajax.blockActiveRequest();
        }
        if (typeof data === "string") {
    ...
    _Tabulator.prototype.addData = function (data, pos, index) {
      var _this25 = this;
      return new Promise(function (resolve, reject) {
        ...
        if (data) {
          _this25.rowManager.addRows(data, pos, index).then(function (rows) {
            var output = [];
            rows.forEach(function (row) {
              output.push(row.getComponent());
            });
    ...
    //update table data
    _Tabulator.prototype.updateOrAddData = function (data) {
      var _this26 = this;
      var self = this,
        rows = [],
        responses = 0;
    ...
    //get row object
    _Tabulator.prototype.getRow = function (index) {
    ...
    //get row object
    _Tabulator.prototype.getRowFromPosition = function (position, active) {
    ...
    _Tabulator.prototype.deleteRow = function (index) {
      var _this27 = this;
      return new Promise(function (resolve, reject) {
        var self = _this27,
          count = 0,
        ...
        index.forEach(function (item) {
          var row = _this27.rowManager.findRow(item, true);
          if (row) {
            foundRows.push(row);
          } else {
        ...
        foundRows.sort(function (a, b) {
          return _this27.rowManager.rows.indexOf(a) > _this27.rowManager.rows.indexOf(b) ? 1 : -1;
        });
    ...
    //add row to table
    _Tabulator.prototype.addRow = function (data, pos, index) {
      var _this28 = this;
      return new Promise(function (resolve, reject) {
        if (typeof data === "string") {
          data = JSON.parse(data);
        }
        _this28.rowManager.addRows(data, pos, index).then(function (rows) {
          //recalc column calculations if present
          if (_this28.modExists("columnCalcs")) {
            _this28.modules.columnCalcs.recalc(_this28.rowManager.activeRows);
          }
    ...
    _Tabulator.prototype.updateOrAddRow = function (index, data) {
      var _this29 = this;
      return new Promise(function (resolve, reject) {
        var row = _this29.rowManager.findRow(index);
        if (typeof data === "string") {
          data = JSON.parse(data);
        }
        if (row) {
          ...
          row = _this29.rowManager.addRows(data).then(function (rows) {
            //recalc column calculations if present
            if (_this29.modExists("columnCalcs")) {
              _this29.modules.columnCalcs.recalc(_this29.rowManager.activeRows);
            }
    ...
    //update row data
    _Tabulator.prototype.updateRow = function (index, data) {
      var _this30 = this;
      return new Promise(function (resolve, reject) {
    ...
    _Tabulator.prototype.scrollToRow = function (index, position, ifVisible) {
      var _this31 = this;
      return new Promise(function (resolve, reject) {
        var row = _this31.rowManager.findRow(index);
        if (row) {
          _this31.rowManager.scrollToRow(row, position, ifVisible).then(function () {
            resolve();
          }).catch(function (err) {
            reject(err);
          });
    ...
    _Tabulator.prototype.moveRow = function (from, to, after) {
    ...
    _Tabulator.prototype.getRows = function (active) {
      if (active === true) {
    ...
    _Tabulator.prototype.getRowPosition = function (index, active) {
      var row = this.rowManager.findRow(index);
      if (row) {
    ...
    _Tabulator.prototype.copyToClipboard = function (selector) {
    ...
    _Tabulator.prototype.setColumns = function (definition) {
      this.columnManager.setColumns(definition);
    };
    _Tabulator.prototype.getColumns = function (structured) {
      return this.columnManager.getComponents(structured);
    };
    _Tabulator.prototype.getColumn = function (field) {
    ...
    _Tabulator.prototype.getColumnDefinitions = function () {
      return this.columnManager.getDefinitionTree();
    };
    _Tabulator.prototype.getColumnLayout = function () {
      if (this.modExists("persistence", true)) {
        return this.modules.persistence.parseColumns(this.columnManager.getColumns());
      }
    };
    _Tabulator.prototype.setColumnLayout = function (layout) {
      if (this.modExists("persistence", true)) {
    ...
    _Tabulator.prototype.showColumn = function (field) {
    ...
    _Tabulator.prototype.hideColumn = function (field) {
      var column = this.columnManager.findColumn(field);
      if (column) {
        column.hide();
        if (this.options.responsiveLayout && this.modExists("responsiveLayout", true)) {
    ...
    _Tabulator.prototype.toggleColumn = function (field) {
      var column = this.columnManager.findColumn(field);
      if (column) {
        if (column.visible) {
          column.hide();
    ...
    _Tabulator.prototype.addColumn = function (definition, before, field) {
      var _this32 = this;
      return new Promise(function (resolve, reject) {
        var column = _this32.columnManager.findColumn(field);
        _this32.columnManager.addColumn(definition, before, column).then(function (column) {
          resolve(column.getComponent());
        }).catch(function (err) {
          reject(err);
        });
    ...
    _Tabulator.prototype.deleteColumn = function (field) {
      var _this33 = this;
      return new Promise(function (resolve, reject) {
    ...
    _Tabulator.prototype.updateColumnDefinition = function (field, definition) {
      var _this34 = this;
      return new Promise(function (resolve, reject) {
    ...
    _Tabulator.prototype.moveColumn = function (from, to, after) {
    ...
    _Tabulator.prototype.scrollToColumn = function (field, position, ifVisible) {
      var _this35 = this;
      return new Promise(function (resolve, reject) {
        var column = _this35.columnManager.findColumn(field);
        if (column) {
          _this35.columnManager.scrollToColumn(column, position, ifVisible).then(function () {
            resolve();
          }).catch(function (err) {
            reject(err);
          });
    ...
    _Tabulator.prototype.setLocale = function (locale) {
      this.modules.localize.setLocale(locale);
    };
    _Tabulator.prototype.getLocale = function () {
      return this.modules.localize.getLocale();
    };
    _Tabulator.prototype.getLang = function (locale) {
    ...
    _Tabulator.prototype.redraw = function (force) {
      this.columnManager.redraw(force);
      this.rowManager.redraw(force);
    };
    _Tabulator.prototype.setHeight = function (height) {
    ...
    //trigger sort
    _Tabulator.prototype.setSort = function (sortList, dir) {
      if (this.modExists("sort", true)) {
        this.modules.sort.setSort(sortList, dir);
        this.rowManager.sorterRefresh();
      }
    };
    _Tabulator.prototype.getSorters = function () {
      if (this.modExists("sort", true)) {
        return this.modules.sort.getSort();
      }
    };
    _Tabulator.prototype.clearSort = function () {
      if (this.modExists("sort", true)) {
    ...
    _Tabulator.prototype.setFilter = function (field, type, value, params) {
      if (this.modExists("filter", true)) {
    ...
    //add filter to array
    _Tabulator.prototype.addFilter = function (field, type, value, params) {
      if (this.modExists("filter", true)) {
    ...
    //get all filters
    _Tabulator.prototype.getFilters = function (all) {
      if (this.modExists("filter", true)) {
        return this.modules.filter.getFilters(all);
      }
    };
    _Tabulator.prototype.setHeaderFilterFocus = function (field) {
      if (this.modExists("filter", true)) {
        var column = this.columnManager.findColumn(field);
        if (column) {
    ...
    _Tabulator.prototype.getHeaderFilterValue = function (field) {
      if (this.modExists("filter", true)) {
        var column = this.columnManager.findColumn(field);
        if (column) {
    ...
    _Tabulator.prototype.setHeaderFilterValue = function (field, value) {
      if (this.modExists("filter", true)) {
        var column = this.columnManager.findColumn(field);
        if (column) {
    ...
    _Tabulator.prototype.getHeaderFilters = function () {
      if (this.modExists("filter", true)) {
    ...
    _Tabulator.prototype.removeFilter = function (field, type, value) {
      if (this.modExists("filter", true)) {
    ...
    //clear filters
    _Tabulator.prototype.clearFilter = function (all) {
      if (this.modExists("filter", true)) {
    ...
    _Tabulator.prototype.clearHeaderFilter = function () {
      if (this.modExists("filter", true)) {
    ...
    ///////////////////// select ////////////////////
    _Tabulator.prototype.selectRow = function (rows) {
    ...
    _Tabulator.prototype.deselectRow = function (rows) {
      if (this.modExists("selectRow", true)) {
        this.modules.selectRow.deselectRows(rows);
      }
    };
    _Tabulator.prototype.toggleSelectRow = function (row) {
      if (this.modExists("selectRow", true)) {
        this.modules.selectRow.toggleRow(row);
      }
    };
    _Tabulator.prototype.getSelectedRows = function () {
      if (this.modExists("selectRow", true)) {
        return this.modules.selectRow.getSelectedRows();
      }
    };
    _Tabulator.prototype.getSelectedData = function () {
      if (this.modExists("selectRow", true)) {
    ...
    ///////////////////// validation  ////////////////////
    _Tabulator.prototype.getInvalidCells = function () {
      if (this.modExists("validate", true)) {
        return this.modules.validate.getInvalidCells();
      }
    };
    _Tabulator.prototype.clearCellValidation = function (cells) {
      var _this36 = this;
      if (this.modExists("validate", true)) {
        if (!cells) {
        ...
        cells.forEach(function (cell) {
          _this36.modules.validate.clearValidation(cell._getSelf());
        });
      }
    };
    _Tabulator.prototype.validate = function (cells) {
      var output = [];
    ...
    _Tabulator.prototype.setMaxPage = function (max) {
    ...
    _Tabulator.prototype.setPage = function (page) {
      if (this.options.pagination && this.modExists("page")) {
    ...
    _Tabulator.prototype.setPageToRow = function (row) {
      var _this37 = this;
      return new Promise(function (resolve, reject) {
        if (_this37.options.pagination && _this37.modExists("page")) {
          row = _this37.rowManager.findRow(row);
          if (row) {
            _this37.modules.page.setPageToRow(row).then(function () {
              resolve();
            }).catch(function () {
              reject();
            });
    ...
    _Tabulator.prototype.setPageSize = function (size) {
      if (this.options.pagination && this.modExists("page")) {
    ...
    _Tabulator.prototype.getPageSize = function () {
      if (this.options.pagination && this.modExists("page", true)) {
        return this.modules.page.getPageSize();
      }
    };
    _Tabulator.prototype.previousPage = function () {
      if (this.options.pagination && this.modExists("page")) {
    ...
    _Tabulator.prototype.nextPage = function () {
      if (this.options.pagination && this.modExists("page")) {
    ...
    _Tabulator.prototype.getPage = function () {
      if (this.options.pagination && this.modExists("page")) {
    ...
    _Tabulator.prototype.getPageMax = function () {
      if (this.options.pagination && this.modExists("page")) {
    ...
    _Tabulator.prototype.setGroupBy = function (groups) {
    ...
    _Tabulator.prototype.setGroupValues = function (groupValues) {
      if (this.modExists("groupRows", true)) {
    ...
    _Tabulator.prototype.setGroupStartOpen = function (values) {
      if (this.modExists("groupRows", true)) {
    ...
    _Tabulator.prototype.setGroupHeader = function (values) {
      if (this.modExists("groupRows", true)) {
    ...
    _Tabulator.prototype.getGroups = function (values) {
      if (this.modExists("groupRows", true)) {
    ...
    _Tabulator.prototype.getGroupedData = function () {
      if (this.modExists("groupRows", true)) {
        return this.options.groupBy ? this.modules.groupRows.getGroupedData() : this.getData();
      }
    };
    _Tabulator.prototype.getEditedCells = function () {
      if (this.modExists("edit", true)) {
        return this.modules.edit.getEditedCells();
      }
    };
    _Tabulator.prototype.clearCellEdited = function (cells) {
      var _this38 = this;
      if (this.modExists("edit", true)) {
        if (!cells) {
        ...
        cells.forEach(function (cell) {
          _this38.modules.edit.clearEdited(cell._getSelf());
        });
      }
    };

    ///////////////// Column Calculation Functions ///////////////
    _Tabulator.prototype.getCalcResults = function () {
    ...
    _Tabulator.prototype.recalc = function () {
      if (this.modExists("columnCalcs", true)) {
    ...
    _Tabulator.prototype.navigatePrev = function () {
      var cell = false;
      if (this.modExists("edit", true)) {
    ...
    _Tabulator.prototype.navigateNext = function () {
      var cell = false;
      if (this.modExists("edit", true)) {
        cell = this.modules.edit.currentCell;
        if (cell) {
    ...
    _Tabulator.prototype.navigateLeft = function () {
      var cell = false;
      if (this.modExists("edit", true)) {
        cell = this.modules.edit.currentCell;
        if (cell) {
    ...
    _Tabulator.prototype.navigateRight = function () {
      var cell = false;
      if (this.modExists("edit", true)) {
        cell = this.modules.edit.currentCell;
        if (cell) {
    ...
    _Tabulator.prototype.navigateUp = function () {
      var cell = false;
      if (this.modExists("edit", true)) {
        cell = this.modules.edit.currentCell;
        if (cell) {
    ...
    _Tabulator.prototype.navigateDown = function () {
      var cell = false;
      if (this.modExists("edit", true)) {
        cell = this.modules.edit.currentCell;
        if (cell) {
    ...
    /////////////// History Management //////////////
    _Tabulator.prototype.undo = function () {
    ...
    _Tabulator.prototype.redo = function () {
      if (this.options.history && this.modExists("history", true)) {
    ...
    _Tabulator.prototype.getHistoryUndoSize = function () {
      if (this.options.history && this.modExists("history", true)) {
    ...
    _Tabulator.prototype.getHistoryRedoSize = function () {
      if (this.options.history && this.modExists("history", true)) {
    ...
    _Tabulator.prototype.download = function (type, filename, options, active) {
      if (this.modExists("download", true)) {
        this.modules.download.download(type, filename, options, active);
      }
    };
    _Tabulator.prototype.downloadToTab = function (type, filename, options, active) {
      if (this.modExists("download", true)) {
    ...
    _Tabulator.prototype.tableComms = function (table, module, action, data) {
    ...
    _Tabulator.prototype.moduleBindings = {};

    //extend module
    _Tabulator.prototype.extendModule = function (name, property, values) {
      if (_Tabulator.prototype.moduleBindings[name]) {
        var source = _Tabulator.prototype.moduleBindings[name].prototype[property];
        if (source) {
    ...
    _Tabulator.prototype.registerModule = function (name, module) {
      var self = this;
      _Tabulator.prototype.moduleBindings[name] = module;
    };

    //ensure that module are bound to instantiated function
    _Tabulator.prototype.bindModules = function () {
      this.modules = {};
      for (var name in _Tabulator.prototype.moduleBindings) {
        this.modules[name] = new _Tabulator.prototype.moduleBindings[name](this);
      }
    };

    //Check for module
    _Tabulator.prototype.modExists = function (plugin, required) {
    ...
    _Tabulator.prototype.comms = {
      tables: [],
      register: function register(table) {
        _Tabulator.prototype.comms.tables.push(table);
      },
      deregister: function deregister(table) {
        var index = _Tabulator.prototype.comms.tables.indexOf(table);
        if (index > -1) {
          _Tabulator.prototype.comms.tables.splice(index, 1);
        }
      },
        ...
        if (typeof query === "string") {
          ...
          if (matches.length) {
            for (var i = 0; i < matches.length; i++) {
              match = _Tabulator.prototype.comms.matchElement(matches[i]);
              if (match) {
                results.push(match);
              }
            }
          }
        } else if (typeof HTMLElement !== "undefined" && query instanceof HTMLElement || query instanceof _Tabulator) {
          match = _Tabulator.prototype.comms.matchElement(query);
          if (match) {
            results.push(match);
          }
        } else if (Array.isArray(query)) {
          query.forEach(function (item) {
            results = results.concat(_Tabulator.prototype.comms.lookupTable(item));
          });
        } else {
          if (!silent) {
      ...
      matchElement: function matchElement(element) {
        return _Tabulator.prototype.comms.tables.find(function (table) {
          return element instanceof _Tabulator ? table === element : table.element === element;
        });
      }
    };
    _Tabulator.prototype.findTable = function (query) {
      var results = _Tabulator.prototype.comms.lookupTable(query, true);
      return Array.isArray(results) && !results.length ? false : results;
    };

    // ===== Included from modules/layout.js =====
    ...
    Layout.prototype.modes = {
      ...
      "fitDataStretch": function fitDataStretch(columns) {
        ...
        columns.forEach(function (column, i) {
          ...
          if (_this39.table.options.responsiveLayout ? column.modules.responsive.visible : column.visible) {
            lastCol = column;
          }
          if (column.visible) {
    ...
    _Tabulator.prototype.registerModule("layout", Layout);
    // ===== End of modules/layout.js =====

    // ===== Included from modules/localize.js =====
    ...
    Localize.prototype.initialize = function () {
      this.langList = _Tabulator.prototype.helpers.deepClone(this.langs);
    };
    ...
    Localize.prototype.setLocale = function (desiredLocale) {
      ...
      self.lang = _Tabulator.prototype.helpers.deepClone(self.langList.default || {});
    ...
    _Tabulator.prototype.registerModule("localize", Localize);
    // ===== End of modules/localize.js =====

    // ===== Included from modules/comms.js =====
    ...
    Comms.prototype.getConnections = function (selectors) {
      var self = this,
        connections = [],
        connection;
      connection = _Tabulator.prototype.comms.lookupTable(selectors);
    ...
    _Tabulator.prototype.registerModule("comms", Comms);
    // ===== End of modules/comms.js =====

    // ===== Included from modules/accessor.js =====
    ...
    Accessor.prototype.transformRow = function (row, type) {
      ...
      var data = _Tabulator.prototype.helpers.deepClone(row.data || {});
    ...
    _Tabulator.prototype.registerModule("accessor", Accessor);
    // ===== End of modules/accessor.js =====

    // ===== Included from modules/ajax.js =====
    ...
    Ajax.prototype._loadDataStandard = function (inPosition, columnsChanged) {
      var _this40 = this;
      return new Promise(function (resolve, reject) {
        _this40.sendRequest(inPosition).then(function (data) {
          _this40.table.rowManager.setData(data, inPosition, columnsChanged).then(function () {
            resolve();
          }).catch(function (e) {
            reject(e);
          });
    ...
    Ajax.prototype.sendRequest = function (silent) {
      ...
      return new Promise(function (resolve, reject) {
        if (self.table.options.ajaxRequesting.call(_this41.table, self.url, self.params) !== false) {
          self.loading = true;
          if (!silent) {
            self.showLoader();
          }
          _this41.loaderPromise(url, self.config, self.params).then(function (data) {
    ...
    _Tabulator.prototype.registerModule("ajax", Ajax);

    // ===== End of modules/ajax.js =====

    // ===== Included from modules/calculation_colums.js =====
    //public calc object
    ...
    ColumnCalcs.prototype.rowsToData = function (rows) {
      ...
      rows.forEach(function (row) {
        ...
        if (_this43.table.options.dataTree && _this43.table.options.dataTreeChildColumnCalcs) {
          if (row.modules.dataTree.open) {
            var children = _this43.rowsToData(_this43.table.modules.dataTree.getFilteredTreeChildren(row));
    ...
    _Tabulator.prototype.registerModule("columnCalcs", ColumnCalcs);

    // ===== End of modules/calculation_colums.js =====

    // ===== Included from modules/clipboard.js =====
    ...
    Clipboard.prototype.initialize = function () {
      ...
      if (this.mode === "fullTableCopyOnly") {
        this.table.element.addEventListener("copy", function (e) {
          ...
          console.log("J: Inside fullTableCopyOnly handler:", _this44.isFullTableCopy);
          if (_this44.isFullTableCopy) {
            var plain, html, list;
            if (!_this44.blocked) {
              e.preventDefault();
              if (_this44.customSelection) {
                plain = _this44.customSelection;
                if (_this44.table.options.clipboardCopyFormatter) {
                  plain = _this44.table.options.clipboardCopyFormatter("plain", plain);
                }
              } else {
                var list = _this44.table.modules.export.generateExportList(_this44.rowRange, _this44.table.options.clipboardCopyStyled, _this44.table.options.clipboardCopyConfig, "clipboard");
                html = _this44.table.modules.export.genereateHTMLTable(list);
                plain = html ? _this44.generatePlainContent(list) : "";
                if (_this44.table.options.clipboardCopyFormatter) {
                  plain = _this44.table.options.clipboardCopyFormatter("plain", plain);
                  html = _this44.table.options.clipboardCopyFormatter("html", html);
                }
              }
              ...
              _this44.table.options.clipboardCopied.call(_this44.table, plain, html);
              _this44.reset();
            }
          } else {
    ...
    _Tabulator.prototype.registerModule("clipboard", Clipboard);

    // ===== End of modules/clipboard.js =====

    // ===== Included from modules/data_tree.js =====
      ...
      if (config.children !== false) {
        if (config.open) {
          ...
          config.controlEl.addEventListener("click", function (e) {
            e.stopPropagation();
            _this45.collapseRow(row);
          });
        } else {
          config.controlEl = this.expandEl.cloneNode(true);
          config.controlEl.addEventListener("click", function (e) {
            e.stopPropagation();
            _this45.expandRow(row);
          });
        }
      ...
      rows.forEach(function (row, i) {
        ...
        if (row instanceof Row) {
          ...
          if (!config.index && config.children !== false) {
            children = _this46.getChildren(row);
    ...
    DataTree.prototype.getChildren = function (row) {
      ...
      if (config.children !== false && config.open) {
        ...
        children.forEach(function (child) {
          output.push(child);
          var subChildren = _this47.getChildren(child);
    ...
    DataTree.prototype.generateChildren = function (row) {
      ...
      childArray.forEach(function (childData) {
        var childRow = new Row(childData || {}, _this48.table.rowManager);
        childRow.modules.dataTree.index = row.modules.dataTree.index + 1;
        childRow.modules.dataTree.parent = row;
        if (childRow.modules.dataTree.children) {
          childRow.modules.dataTree.open = _this48.startOpen(childRow.getComponent(), childRow.modules.dataTree.index);
        }
    ...
    DataTree.prototype.findChildIndex = function (subject, parent) {
      ...
      if (_typeof(subject) == "object") {
        ...
        match = parent.data[this.field].find(function (row) {
          return row.data[_this49.table.options.index] == subject;
        });
      }
      if (match) {
      ...
      if (config.children) {
        ...
        config.children.forEach(function (childRow) {
          if (childRow instanceof Row) {
            ...
            if (recurse) {
              output = output.concat(_this50.getTreeChildren(childRow, component, recurse));
            }
          }
        });
      }
    ...
    _Tabulator.prototype.registerModule("dataTree", DataTree);

    // ===== End of modules/data_tree.js =====

    // ===== Included from modules/download.js =====
    ...
    _Tabulator.prototype.registerModule("download", Download);

    // ===== End of modules/download.js =====

    // ===== Included from modules/edit.js =====
    ...
    Edit.prototype.initializeColumn = function (column) {
      ...
      console.log("[Tabulator edit.js initializeColumn]", {
        ...
        cellForceEditTriggerType: _typeof(column.definition.cellForceEditTrigger)
      });
    ...
    Edit.prototype.edit = function (cell, e, forceEdit) {
      ...
      if (e === false) {
        ...
        if (typeof cell.column.modules.edit.cellForceEditTrigger === "function") {
          ...
          console.warn("[Tabulator edit.js] ❌ cellForceEditTrigger is NOT a function, type:", _typeof(cell.column.modules.edit.cellForceEditTrigger));
        }
      ...
      select: function select(cell, onRendered, success, cancel, editorParams) {
        ...
        function showList() {
          ...
          if (!listEl.parentNode) {
            ...
            var offset = _Tabulator.prototype.helpers.elOffset(cellEl);
    ...
    _Tabulator.prototype.registerModule("edit", Edit);

    // ===== End of modules/edit.js =====

    // ===== Included from modules/export.js =====
    ...
    Export.prototype.headersToExportRows = function (columns) {
      ...
      function parseColumnGroup(column, level) {
        ...
        if (column.height > 1) {
          for (var _i0 = 1; _i0 < column.height; _i0++) {
            if (typeof headers[level + _i0] === "undefined") {
              headers[level + _i0] = [];
            }
            headers[level + _i0].push(false);
          }
        }
        if (column.width > 1) {
          for (var _i1 = 1; _i1 < column.width; _i1++) {
    ...
    _Tabulator.prototype.registerModule("export", Export);

    // ===== End of modules/export.js =====

    // ===== Included from modules/filter.js =====
    ...
    _Tabulator.prototype.registerModule("filter", Filter);

    // ===== End of modules/filter.js =====

    // ===== Included from modules/format.js =====
    ...
    _Tabulator.prototype.registerModule("format", Format);

    // ===== End of modules/format.js =====

    // ===== Included from modules/frozen_columns.js =====
    ...
    FrozenColumns.prototype._calcSpace = function (columns, index) {
      var width = 0;
      for (var _i10 = 0; _i10 < index; _i10++) {
        if (columns[_i10].visible) {
          width += columns[_i10].getWidth();
        }
      }
      return width;
    };
    _Tabulator.prototype.registerModule("frozenColumns", FrozenColumns);
    // ===== End of modules/frozen_columns.js =====

    // ===== Included from modules/frozen_rows.js =====
    ...
    _Tabulator.prototype.registerModule("frozenRows", FrozenRows);
    // ===== End of modules/frozen_rows.js =====

    // ===== Included from modules/group_rows.js =====
    ...
    _Tabulator.prototype.registerModule("groupRows", GroupRows);
    // ===== End of modules/group_rows.js =====

    // ===== Included from modules/history.js =====
    ...
    _Tabulator.prototype.registerModule("history", History);
    // ===== End of modules/history.js =====

    // ===== Included from modules/html_table_import.js =====
    ...
    HtmlTableImport.prototype._extractHeaders = function (headers, rows) {
      for (var index = 0; index < headers.length; index++) {
        ...
        // //check for tablator inline options
        this._extractOptions(header, col, _Column.prototype.defaultOptionList);
    ...
    _Tabulator.prototype.registerModule("htmlTableImport", HtmlTableImport);
    // ===== End of modules/html_table_import.js =====

    // ===== Included from modules/keybindings.js =====
    ...
    _Tabulator.prototype.registerModule("keybindings", Keybindings);
    // ===== End of modules/keybindings.js =====

    // ===== Included from modules/menu.js =====
          ...
          if (disabled) {
            ...
            if (item.menu && item.menu.length) {
              itemEl.addEventListener("mouseenter", function (e) {
                _this71.showSubmenu(e, itemEl, item.menu, component);
              });
              itemEl.addEventListener("click", function (e) {
                e.stopPropagation();
              });
    ...
    _Tabulator.prototype.registerModule("menu", Menu);
    // ===== End of modules/menu.js =====

    // ===== Included from modules/moveable_columns.js =====
      ...
      if (!column.modules.frozen) {
        ...
        config.mousemove = function (e) {
          if (column.parent === self.moving.parent) {
            if ((self.touchMove ? e.touches[0].pageX : e.pageX) - _Tabulator.prototype.helpers.elOffset(colEl).left + self.table.columnManager.element.scrollLeft > column.getWidth() / 2) {
    ...
    MoveColumns.prototype.startMove = function (e, column) {
      ...
      this.moving = column;
      this.startX = (this.touchMove ? e.touches[0].pageX : e.pageX) - _Tabulator.prototype.helpers.elOffset(element).left;
    ...
    MoveColumns.prototype.moveHover = function (e) {
      var self = this,
        ...
        xPos = (self.touchMove ? e.touches[0].pageX : e.pageX) - _Tabulator.prototype.helpers.elOffset(columnHolder).left + scrollLeft,
        scrollPos;
    ...
    _Tabulator.prototype.registerModule("moveColumn", MoveColumns);

    // ===== End of modules/moveable_columns.js =====

    // ===== Included from modules/moveable_rows.js =====
    ...
    MoveRows.prototype.initializeGroupHeader = function (group) {
      ...
      config.mousemove = function (e) {
        if (e.pageY - _Tabulator.prototype.helpers.elOffset(group.element).top + self.table.rowManager.element.scrollTop > group.getHeight() / 2) {
    ...
    MoveRows.prototype.initializeRow = function (row) {
      ...
      //same table drag drop
      config.mousemove = function (e) {
        if (e.pageY - _Tabulator.prototype.helpers.elOffset(row.element).top + self.table.rowManager.element.scrollTop > row.getHeight() / 2) {
    ...
    MoveRows.prototype.connectToTables = function (row) {
      ...
      if (this.connectionSelectorsElements) {
        ...
        this.connectionSelectorsElements.forEach(function (query) {
          if (typeof query === "string") {
            _this73.connectionElements = _this73.connectionElements.concat(Array.prototype.slice.call(document.querySelectorAll(query)));
          } else {
            _this73.connectionElements.push(query);
          }
        });
        this.connectionElements.forEach(function (element) {
          var dropEvent = function dropEvent(e) {
            _this73.elementRowDrop(e, element, _this73.moving);
          };
    ...
    _Tabulator.prototype.registerModule("moveRow", MoveRows);
    // ===== End of modules/moveable_rows.js =====

    // ===== Included from modules/mutator.js =====
    ...
    _Tabulator.prototype.registerModule("mutator", Mutator);
    // ===== End of modules/mutator.js =====

    // ===== Included from modules/page.js =====
    ...
    Page.prototype.generatePageSizeSelectList = function () {
      ...
      if (this.pageSizeSelect) {
        ...
        pageSizes.forEach(function (item) {
          ...
          itemEl.value = item;
          if (item === true) {
            _this74.table.modules.localize.bind("pagination|all", function (value) {
              itemEl.innerHTML = value;
            });
          } else {
            itemEl.innerHTML = item;
          }
          _this74.pageSizeSelect.appendChild(itemEl);
        });
    ...
    Page.prototype.setPage = function (page) {
      ...
      return new Promise(function (resolve, reject) {
        page = parseInt(page);
        if (page > 0 && page <= _this75.max) {
          _this75.page = page;
          _this75.trigger().then(function () {
            resolve();
          }).catch(function () {
            reject();
          });
          ...
          console.warn("Pagination Error - Requested page is out of range of 1 - " + _this75.max + ":", page);
          reject();
        }
      });
    };
    Page.prototype.setPageToRow = function (row) {
      var _this76 = this;
      return new Promise(function (resolve, reject) {
        var rows = _this76.table.rowManager.getDisplayRows(_this76.displayIndex - 1);
        var index = rows.indexOf(row);
        if (index > -1) {
          var page = _this76.size === true ? 1 : Math.ceil((index + 1) / _this76.size);
          _this76.setPage(page).then(function () {
            resolve();
          }).catch(function () {
            reject();
          });
    ...
    Page.prototype._setPageButtons = function () {
      ...
      for (var _i12 = min; _i12 <= max; _i12++) {
        if (_i12 > 0 && _i12 <= self.max) {
          self.pagesElement.appendChild(self._generatePageButton(_i12));
        }
      }
      this.footerRedraw();
    };
    ...
    Page.prototype.nextPage = function () {
      ...
      return new Promise(function (resolve, reject) {
        if (_this78.page < _this78.max) {
          ...
          if (!_this78.progressiveLoad) {
            console.warn("Pagination Error - Next page would be greater than maximum page of " + _this78.max + ":", _this78.max + 1);
          }
          reject();
        }
      });
    ...
    Page.prototype.trigger = function () {
      ...
      return new Promise(function (resolve, reject) {
        switch (_this79.mode) {
          case "local":
            left = _this79.table.rowManager.scrollLeft;
            _this79.table.rowManager.refreshActiveData("page");
            _this79.table.rowManager.scrollHorizontal(left);
            _this79.table.options.pageLoaded.call(_this79.table, _this79.getPage());
            resolve();
            break;
          case "remote":
          case "progressive_load":
          case "progressive_scroll":
            _this79.table.modules.ajax.blockActiveRequest();
            _this79._getRemotePage().then(function () {
              resolve();
            }).catch(function () {
              reject();
            });
            break;
          default:
            console.warn("Pagination Error - no such pagination mode:", _this79.mode);
            reject();
        }
      });
    };
    Page.prototype._getRemotePage = function () {
      ...
      return new Promise(function (resolve, reject) {
        ...
        oldParams = _Tabulator.prototype.helpers.deepClone(self.table.modules.ajax.getParams() || {});
        pageParams = self.table.modules.ajax.getParams();

        //configure request params
        pageParams[_this80.dataSentNames.page] = self.page;

        //set page size if defined
        if (_this80.size) {
          pageParams[_this80.dataSentNames.size] = _this80.size;
        }

        //set sort data if defined
        if (_this80.table.options.ajaxSorting && _this80.table.modExists("sort")) {
          var sorters = self.table.modules.sort.getSort();
          sorters.forEach(function (item) {
            delete item.column;
          });
          pageParams[_this80.dataSentNames.sorters] = sorters;
        }

        //set filter data if defined
        if (_this80.table.options.ajaxFiltering && _this80.table.modExists("filter")) {
          var filters = self.table.modules.filter.getFilters(true, true);
          pageParams[_this80.dataSentNames.filters] = filters;
        }
        self.table.modules.ajax.setParams(pageParams);
        self.table.modules.ajax.sendRequest(_this80.progressiveLoad).then(function (data) {
    ...
    _Tabulator.prototype.registerModule("page", Page);

    // ===== End of modules/page.js =====

    // ===== Included from modules/persistence.js =====
    ...
    _Tabulator.prototype.registerModule("persistence", Persistence);

    // ===== End of modules/persistence.js =====

    // ===== Included from modules/print.js =====
    ...
    _Tabulator.prototype.registerModule("print", Print);
    // ===== End of modules/print.js =====

    // ===== Included from modules/reactive_data.js =====
    ...
    _Tabulator.prototype.registerModule("reactiveData", ReactiveData);

    // ===== End of modules/reactive_data.js =====

    // ===== Included from modules/resize_columns.js =====
    ...
    _Tabulator.prototype.registerModule("resizeColumns", ResizeColumns);
    // ===== End of modules/resize_columns.js =====

    // ===== Included from modules/resize_rows.js =====
    ...
    _Tabulator.prototype.registerModule("resizeRows", ResizeRows);
    // ===== End of modules/resize_rows.js =====

    // ===== Included from modules/resize_table.js =====
      ...
      if (typeof ResizeObserver !== "undefined" && table.rowManager.getRenderMode() === "virtual") {
        ...
        this.observer = new ResizeObserver(function (entry) {
          if (!table.browserMobile || table.browserMobile && !table.modules.edit.currentCell) {
            ...
            if (_this81.tableHeight != nodeHeight || _this81.tableWidth != nodeWidth) {
              _this81.tableHeight = nodeHeight;
              _this81.tableWidth = nodeWidth;
              if (table.element.parentNode) {
                _this81.containerHeight = table.element.parentNode.clientHeight;
        ...
        if (this.table.element.parentNode && !this.table.rowManager.fixedHeight && (tableStyle.getPropertyValue("max-height") || tableStyle.getPropertyValue("min-height"))) {
          this.containerObserver = new ResizeObserver(function (entry) {
            if (!table.browserMobile || table.browserMobile && !table.modules.edit.currentCell) {
              var nodeHeight = Math.floor(entry[0].contentRect.height);
              var nodeWidth = Math.floor(entry[0].contentRect.width);
              if (_this81.containerHeight != nodeHeight || _this81.containerWidth != nodeWidth) {
                _this81.containerHeight = nodeHeight;
    ...
    _Tabulator.prototype.registerModule("resizeTable", ResizeTable);
    // ===== End of modules/resize_table.js =====

    // ===== Included from modules/responsive_layout.js =====
    ...
    _Tabulator.prototype.registerModule("responsiveLayout", ResponsiveLayout);

    // ===== End of modules/responsive_layout.js =====

    // ===== Included from modules/select_row.js =====
    ...
    SelectRow.prototype.initializeRow = function (row) {
      ...
      var _endSelect = function endSelect() {
        setTimeout(function () {
          self.selecting = false;
        }, 50);
        document.body.removeEventListener("mouseup", _endSelect);
      };
      row.modules.select = {
        selected: false
      };
          ...
          if (self.table.options.selectableRangeMode === "click") {
            ...
            element.addEventListener("mousedown", function (e) {
              if (e.shiftKey) {
                ...
                self.selecting = true;
                self.selectPrev = [];
                document.body.addEventListener("mouseup", _endSelect);
                document.body.addEventListener("keyup", _endSelect);
                self.toggleRow(row);
                return false;
              }
            });
    ...
    SelectRow.prototype.selectRows = function (rows) {
      ...
      switch (_typeof(rows)) {
        case "undefined":
          this.table.rowManager.rows.forEach(function (row) {
            _this82._selectRow(row, true, true);
          });
          this._rowSelectionChanged();
          break;
        case "string":
    ...
    _Tabulator.prototype.registerModule("selectRow", SelectRow);

    // ===== End of modules/select_row.js =====

    // ===== Included from modules/sort.js =====
    ...
    Sort.prototype._sortItems = function (data, sortList) {
      ...
      data.sort(function (a, b) {
        ...
        for (var i = sorterCount; i >= 0; i--) {
          ...
          result = _this83._sortRow(a, b, sortItem.column, sortItem.dir, sortItem.params);
          if (result !== 0) {
            break;
          }
        }
    ...
    _Tabulator.prototype.registerModule("sort", Sort);

    // ===== End of modules/sort.js =====

    // ===== Included from modules/validate.js =====
    ...
    _Tabulator.prototype.registerModule("validate", Validate);

    // ===== End of modules/validate.js =====
